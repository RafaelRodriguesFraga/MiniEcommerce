...
public class AddressDocs : BaseDoc<AddressDocKey>
{
    static AddressDocs()
    {
        Docs[AddressDocKey.GetById] = new ApiDocInfo(
        ...
        Docs[AddressDocKey.GetAllByCustomerId] = new ApiDocInfo(
        ...
        Docs[AddressDocKey.Create] = new ApiDocInfo(
        ...
        Docs[AddressDocKey.Update] = new ApiDocInfo(
        ...
        Docs[AddressDocKey.Delete] = new ApiDocInfo(
